...
public class BN12DA3 extends NextFTCOpMode {
    ...
    private final Pose2d shotPoseOffLine = new Pose2d(-40, -16, Math.toRadians(290));
    //-29, 23
    //-2.55, 7.10
    ...
    private Command autoAimWithPID() {
        return new Command() {
            ...
            public void update() {
                ...
                double power = BaseRobot.INSTANCE.turret.visionPID(tx + 4.5); // PID calculation //was 4.5
    ...
    public void onInit(){
        ...
        autoCommand = drive.commandBuilder(startPose)
                ...
                .stopAndAdd(robot.shooter.setTargetRPM(2230))
                ...
                .stopAndAdd(robot.shooter.setTargetRPM(2220))
                //SHOT SEQUENCE------------------------------
                ...
                .strafeToConstantHeading(new Vector2d(-10, -48), new TranslationalVelConstraint(100),  new ProfileAccelConstraint(-100,100))//intake
                .stopAndAdd(robot.shooter.spin())
                ...
                .strafeToConstantHeading(new Vector2d(-4, -44), new TranslationalVelConstraint(100))//intake
                .strafeToConstantHeading(new Vector2d(-4, -50), new TranslationalVelConstraint(100))//intake
                .stopAndAdd(robot.intake.stop())
                ...
                .strafeToConstantHeading(new Vector2d(35, -60), new TranslationalVelConstraint(60), new ProfileAccelConstraint(-40, 40))//back up
